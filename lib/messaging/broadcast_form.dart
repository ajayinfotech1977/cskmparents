  ...
  Future<void> fetchClasses() async {
    try {
      ...
      Map<String, dynamic> postData = {
        ...
        'userNo': AppConfig.globaladm_no, // Replace with the actual user number
      };
      final String apiUrl =
          'https://www.cskm.com/schoolexpert/cskmparents/fetch_classes.php';
